    ...
    class PageView{
        ...
        public function showArticuloProcesadores(){
            ...
            foreach($procesadores as $proce){
                echo '<article class="producto">' . '<h2>' . $proce->Marca . '<h2>' . '<h2>' . $proce->Modelo . '</h2>' .  '<h3>' . $proce->Socket . '<br>' . '<br>' . '$' . $proce->Valor . '</h3>' . 'ID: ' . $proce->ID_procesadores  . '<br>' . '<br>' . '<div class="button_slide slide_left"><a href="#">Añadir al carrito</a></div>' .'</article>';
            }
            echo '</section>';
        }
        ...
        public function showArticuloGraficas(){
            ...
            foreach($placas as $placa){
                echo '<article class="producto">' . $placa->Marca . '<h2>' . $placa->Modelo . '</h2>' .  '<h3>' . $placa->Vram . '<br>' . '<br>' . $placa->Valor . '<br>' . '<br>' . 'ID: ' . $placa->ID_graficas . '</h3>' . '<br>' . '<div class="button_slide slide_left"><a href="#">Añadir al carrito</a></div>' .'</article>';
            }
            echo '</section>';
        }
        ...
        public function showArticuloRams(){
            ...
            foreach($rams as $ram){
                echo '<article class="producto">' . $ram->Marca . '<h2>' . $ram->Tamaño . '</h2>' .  '<h3>' . $ram->Generacion . '<br>' . '<br>' . $ram->Velocidad . '<br>' . '<br>' . $ram->Valor . '<br>' . '<br>' . 'ID: ' . $ram->ID_RAM . '</h3>' . '<br>' . '<div class="button_slide slide_left"><a href="#">Añadir al carrito</a></div>' .'</article>';
            }
            echo '</section>';
        }
        ...
        public function showArticuloGabinetes(){
            ...
            foreach($gabinetes as $gabinete){
                echo '<article class="producto">' . $gabinete->Marca . '<h2>' . $gabinete->Modelo . '</h2>' .  '<h3>' . $gabinete->Tamaño . '<br>' . '<br>' .  $gabinete->Valor . '<br>' . '<br>' . 'ID: ' . $gabinete->ID_gabinete . '</h3>' . '<br>' . '<div class="button_slide slide_left"><a href="#">Añadir al carrito</a></div>' .'</article>';
            }
            echo '</section>';
        }
    }
